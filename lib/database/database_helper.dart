...
class DatabaseHelper {
  ...
  // MENAMBAHKAN FILTER LAPORAN BERDASARKAN TANGGAL (KELOMPOK 5)
  ...
  // MENAMBAHKAN GRAFIK BATANG PENJUALAN HARIAN
  Future<List<Map<String, dynamic>>> getDailySalesChartData(
      DateTime startDate, DateTime endDate) async {
    final db = await instance.database;
    final result = await db.rawQuery('''
      SELECT strftime('%Y-%m-%d', transactionDate) as date, 
